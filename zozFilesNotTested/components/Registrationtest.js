...
function sendData(email,password) {
    ...
    const result =  axios.post('/register', params, {headers: {'Content-Type': 'application/x-www-form-urlencoded'}} )
...
function RegisterationTest() {
  ...
  export default RegisterationTest;